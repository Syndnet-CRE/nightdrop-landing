  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$150",
      annualPrice: "$135",
      description: "One buy box. Up to 5 matched deals every morning.",
      features: [
        "1 active buy box",
        "Up to 5 deals per night",
        "AI confidence scoring on every deal",
        "Distress signal detection",
        "Owner contact via skip trace",
        "30-day free trial",
    ...
    },
    {
      ...
      features: [
        ...
        "Additional buy boxes at $50/mo each",
        "Up to 5 deals per buy box per night",
        "AI confidence scoring on every deal",
        "Distress signal detection",
        "Owner contact via skip trace",
        "No contract, cancel anytime",
    ...
    },
    {
      ...
      monthlyPrice: "Custom",
      annualPrice: "Custom",
      description: "More than 5 buy boxes or custom deal volume. Let's talk.",
      features: [
        "Unlimited buy boxes",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            One buy box. Multiple markets. No contracts. Cancel anytime.
          </p>
        </div>
        <div className="pt-4">
